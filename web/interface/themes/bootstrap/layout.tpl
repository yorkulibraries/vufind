...
<head>
  ...
  <!-- our stylesheets -->
  {minifycss media="all" files="font-awesome.min.css,bootstrap.min.css,bootstrap-theme.min.css,datepicker.css,pretify.css,jquery.fileupload.css,slick.css,slick-theme.css,styles.css.less"}
...
<body>
  ...
  <script type="text/javascript" src="{$path}/interface/themes/bootstrap/min/f=js/jquery.min.js,js/bootstrap.min.js,js/bootstrap-datepicker.js,js/jquery.ui.widget.js,js/jquery.fileupload.js,js/jquery.cookie.js,js/slick.min.js,js/bootstrap-toolkit.min.js,js/vufind.js"></script>
  {if $gaId}  
  <script type="text/javascript">
      {literal}
