...
class MarcRecord extends IndexRecord
{
    ...
    protected function redirectToRefWorks()
    {
        ...
        // We have to use http since refworks direct importer (and wget)
        // has trouble with EV certificates
        $exportUrl = str_replace('https://', 'http://', $configArray['Site']['url']) . '/Record/' .
