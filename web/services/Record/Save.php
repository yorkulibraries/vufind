...
class Save extends Action
{
    ...
    public function launch()
    {
        ...
        $saved = $this->_user->getSavedData($_REQUEST['id']);
    ...
    public static function saveRecord($user)
    {
        ...
        $list = new User_list();
        if ($_REQUEST['list'] != '' && strlen(trim($_REQUEST['listname'])) == 0) {
        ...
        $resource->service = $_REQUEST['service'];
        ...
        return $user->addResource(
            $resource, $list, $tagArray[0], $_REQUEST['notes']
        );
    }
